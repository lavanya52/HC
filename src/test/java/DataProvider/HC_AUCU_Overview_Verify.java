 ...
 *
 */
public class HC_AUCU_Overview_Verify extends ConfigReader {
	...
	{
		String URL = "https://" + Web_Login + ":" + Web_Password + "@" + IP_ADDRESS + "/hc.php?hc=hc_aucusystem";
		...
		//HC_AU_CU_AU_FRANCE_CU_FRANCE_MF_SER_190520
		...
		compareData(csvfileName,rowsize,custSize,path,12,path2,14);
	...
	public void verify_IMT_ALL_NET() throws Exception
	{
		...
		//HC_AU_CU_AU_FRANCE_CU_FRANCE_ALL_NET_190520
	...
	public void verify_IMT_DS_STO() throws Exception
	{
		...
		//HC_AU_CU_AU_FRANCE_CU_FRANCE_DS_STO_190520
	...
	public void verify_AllIMT_MF_SST() throws Exception
	{
		...
		//HC_AU_CU_AU_FRANCE_CU_FRANCE_ALL_ALL_190520
	...
	public String CsvDownload(String osFamily,String reportSys) throws Exception
	{
		...
		//HC_AU_CU_AU_FRANCE_CU_FRANCE_ALL_SER_190520
		
		if(reportSys.equalsIgnoreCase("ALL")) {
			String FilePartialName1 = "HC_AU_CU_AU_"+COUNTRY_NAME+"_"+osFamily+ "_" +reportSys;
			String csvfileName = downloadCSV(driver, FilePartialName1, Local_Folder_HC, "0");
			return csvfileName;
		}
		
		else {
			String FilePartialName1 = "HC_AU_CU_AU_"+COUNTRY_NAME+"_CU_"+COUNTRY_NAME+"_"+osFamily+ "_" +reportSys;
			String csvfileName = downloadCSV(driver, FilePartialName1, Local_Folder_HC, "0");
			return csvfileName;
		}
	...
	public void compareData(String fileName,int rowsize,int custSize,String path,int columnSize,String path2,int columnSize2)
	{
		...
		{ 
			...
			String webColum = HC_AUCU_Overview_Web_Column_Summary[a]; 
			int csvColum =	Integer.parseInt(HC_AUCU_Overview_CSV_Column_Summary[a]);
		...
		if(custSize != 0)
		{
			...
			{ 
				System.out.println("**************FOR 1*******************");
				String webColum = HC_AUCU_Overview_Web_Column_Customers[a]; 
				int csvColum =	Integer.parseInt(HC_AUCU_Overview_CSV_Column_Customers[a]);
	...
	public void compareColumnHeading (String fileName,int custSize) throws Exception
	{
		File CSVHeadersFile;
			...
			CSVHeadersFile = new File("CSV\\HC_AUCU_Overview.xls");
		...
		if(custSize != 0)
		{
			...
			for (int i = 0; i <= 26; i++)
			{
				...
				Assert.assertEquals(wb1.getSheet(0).getCell(i, 3).getContents().toLowerCase().trim(),getCellValueFromCSV(fileName, 3, i, Local_Folder_HC, CSV_Separator).toLowerCase());
