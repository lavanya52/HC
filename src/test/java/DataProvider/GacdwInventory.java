...
public class GacdwInventory extends ConfigReader implements Report {
	...
	public GacdwInventory(String[] inventoryLoad, Date dateID, int status, int scenario,String ReportedFamily) {
		...
		setField(2,"NA IMI");//New Account Sector Type to be added for the IMI req FR21576
		...
		{
			case 1:
					setField(60, "Production");
					break;
			
			case 2:
					setField(60, "Prod. Transition In");
					break;
					
			case 3:
					setField(60, "Deployment");
					break;
		}
