 ...
 *
 */
public class HCOverview_Page {

	WebDriver driver;

	public HCOverview_Page(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindAll({@FindBy(how = How.XPATH, using = "html/body/div[1]/div[2]/div/div[1]/div[2]/div/div[5]/div/table[1]/tbody/tr")})
