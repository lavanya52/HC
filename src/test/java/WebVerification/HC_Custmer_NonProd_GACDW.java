...
public class HC_Custmer_NonProd_GACDW {
	...
	public void pageVerify() throws Exception
	{
		...
		verify.verify_DEPLOYMENT_ALL_ALL_NET();
		verify.verify_TRANSITION_DS_ALL_ALL();
		verify.verify_TRANSITION_MF_ALL_STO();
		verify.verify_DEPLOYMENT_ALL_ALL_SER();
